...
def sarsa_on_tic_tac_toe_solo() -> PolicyAndActionValueFunction:
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'sarsa_tic_tac_toe', result.q)
    return result
...
def q_learning_on_tic_tac_toe_solo() -> PolicyAndActionValueFunction:
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'q_learning_tic_tac_toe', result.q)
    return result
...
def expected_sarsa_on_tic_tac_toe_solo() -> PolicyAndActionValueFunction:
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'expected_sarsa_tic_tac_toe', result.q)
    return result
...
def sarsa_on_secret_env3() -> PolicyAndActionValueFunction:
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'sarsa_secret_env_3', result.q)
    return result
...
def q_learning_on_secret_env3() -> PolicyAndActionValueFunction:
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'q_learning_secret_env_3', result.q)
    return result
...
def expected_sarsa_on_secret_env3() -> PolicyAndActionValueFunction:
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'expected_sarsa_secret_env_3', result.q)
    return result


def sarsa_on_line_world():
    result = get_sarsa(EnvLineWorldSingleAgent(7, 1000), 0.1, 1.0, 0.9, max_iter)
    drl_sample_project_python.main.export_to_json(result.pi, 'sarsa_line_world', result.q)


def q_learning_on_line_world():
    result = get_q_learning(EnvLineWorldSingleAgent(7, 1000), 0.1, 1.0, 0.9, max_iter)
    drl_sample_project_python.main.export_to_json(result.pi, 'q_learning_line_world', result.q)
...
def expected_sarsa_on_line_world():
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'expected_sarsa_line_world', result.q)


def sarsa_on_grid_world():
    result = get_sarsa(EnvGridWorldSingleAgent(5, 5, 1000, (4, 4), (0, 0)), 0.1, 1.0, 0.9, max_iter)
    drl_sample_project_python.main.export_to_json(result.pi, 'sarsa_grid_world', result.q)


def q_learning_on_grid_world():
    result = get_q_learning(EnvGridWorldSingleAgent(5, 5, 1000, (4, 4), (0, 0)), 0.1, 1.0, 0.9, max_iter)
    drl_sample_project_python.main.export_to_json(result.pi, 'q_learning_grid_world', result.q)
...
def expected_sarsa_on_grid_world():
    ...
    drl_sample_project_python.main.export_to_json(result.pi, 'expected_sarsa_grid_world', result.q)
